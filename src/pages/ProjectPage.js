  ...
  render() {
    return (
      <div className="projectPage">
        <Project link="https://github.com/nickknapton12/MTB-FantasyLeage-App" theId={"project1"} image={fantasyLeaguePic} title="MTB Fantasy League" description="This is a Fantasy Sports app for my favorite sport, mountain biking! It is built off the MERN stack (MongoDB, Express, Reactjs, Nodejs), it features login and signup with password encryption using bcryptjs, JWT tokens, aswell as all the functionality you would expect from a fantasy sport site (joining and creating leagues, teams, rankings, news, results, etc)!" />
        <Project link="https://github.com/nickknapton12/Sudoku-Solver-Visualizer" theId={"project2"} image={sudokuPic} title="Sudoku Solver Visualizer" description="This project I made to solve the classic game of Sudoku! It uses a backtracking algorithm to move through the puzzle and find the correct solution. Features variable speed to either find instant solution or to see the algorithm in work! See it in action in the github README."/>
