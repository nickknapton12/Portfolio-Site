...
function ContactPage() {
    ...
    >{props => (
      <animated.div style={props}>
        <h2 className="ContactPageHeader">Get In Contact</h2>
        <h3 className="landingPageSubHeader">Feel free to <span style={{ color: `#61dafb` }}>reach me</span> at any of the links below...</h3>
        <a target="_blank" href="mailto:nickknapton12@gmail.com">
        <div className="introContainer">
        <i class="material-icons" style={{ color: `white`, fontSize: `40px` }}>email</i>
          <h3 className="landingPageSubHeader" id="school">
            Email
          </h3>
        </div>
        </a>
        <a target="_blank" href="https://www.linkedin.com/in/nicholasknapton/">
        <div className="introContainer" id="contactContainSmall">
        <svg viewBox="0 0 128 128" className="githubIcon">
        ...
        <a target="_blank" href="https://github.com/nickknapton12">
        <div className="introContainer" id="contactContainSmall">
        <svg viewBox="0 0 128 128" className="githubIcon">
        ...
        <div className="introContainer" id="contactContainSmall">
          <i class="material-icons" id="atIcon" style={{ color: `white`, fontSize: `40px` }}>
            content_paste
          </i>
          <h3 className="landingPageSubHeader" id="school">
            Resume
